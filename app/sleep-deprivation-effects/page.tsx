...
import { Clock, AlertTriangle, Brain, Heart, Frown, ChevronRight, Shield, Car, Hospital, Menu } from 'lucide-react'
          ...
          <AnimatePresence>
            {isMobileMenuOpen && (
              ...
              >
                ...
                >
                  <Link href="/" className="block text-sm font-medium text-gray-300 hover:text-white transition-colors px-2">
                    Home
                  </Link>
                </motion.div>
                <motion.div
                ...
                >
                  <Link href="/what-is-sleep" className="block text-sm font-medium text-gray-300 hover:text-white transition-colors px-2">
                    What is Sleep?
                  </Link>
                </motion.div>
                <motion.div
                ...
                >
                  <Link href="#" className="block text-sm font-medium text-[#67B8FF] hover:text-[#4A90E2] transition-colors px-2">
                ...
                >
                  <Link href="/calculator" className="block text-sm font-medium text-gray-300 hover:text-white transition-colors px-2">
